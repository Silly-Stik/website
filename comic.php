...
?>
<div class="ctr"><span class="btn"><a class="ctext" href="comic?c=1">|<</a></span> <span class="btn"><?php
if($_GET["c"] != 1){
	echo "<a class=\"ctext\" href=\"comic?c=".((int)$_GET["c"]-1)."\">Prev</a>";
}else{
	echo "<span class=\"ctext\">Previous</span>";
}?></span> <span class="btn"><a class="ctext" href="random">Random</a></span> <span class="btn"><?php
if((int)$_GET["c"] < count($titles)){
	echo "<a class=\"ctext\" href=\"comic?c=".((int)$_GET["c"]+1)."\">Next</a>";
}else{
	echo "<span class=\"ctext\">Next</span>";
}?></span> <span class="btn"><a class="ctext" href="comic?c=<?php echo count($titles); ?>">>|</a></span></div>
...
<p class="ctr ctext">Permanent link to the comic: <a href=<?php echo "http://sillystik.com/comic?c=".$_GET["c"]; ?>><?php echo "sillystik.com/comic?c=".$_GET["c"]; ?></a></p>
